...
```bash
go install github.com/plexusone/api-style-spec/cmd/api-style@v0.2.0
```
...
- [GitHub Repository](https://github.com/plexusone/api-style-spec)
- [Documentation](https://plexusone.github.io/api-style-spec)
